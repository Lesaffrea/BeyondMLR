...
```{r, comment = NA}
# Model with just distance the cbind is special to glm binomial, you give the success and the failure rather tan a proportion in this case
model.HaleD <- glm(cbind(YesVotes, NumVotes - YesVotes) ~
    distance, family = binomial, data = rrHale.df)
# alternative expression this is way I shall do !!!
